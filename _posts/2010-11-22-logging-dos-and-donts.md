...
```
By the time the root method actually recovers, we've logged the same low level exception as error five times! And _all_ of the information was logged by the last log.error call in the root method.
